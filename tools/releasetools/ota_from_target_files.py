...
""" % bcb_dev)
  ...
  build_date = target_info.GetBuildProp("org.slimaosp.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("org.slimaosp.device")

  script.Print("----------------------------------------------");
  script.Print("              SlimAOSP");
  script.Print("              The Stock Experience");
  script.Print("----------------------------------------------");
